...
echo ^<p^>WINDOWS ERROR^</p^> 
echo.
echo ^<p^>DO NOT ATTEMPT TO SHUT DOWN OR POWER OFF THE COMPUTER^</p^> 
echo. 
echo ^<p^>CALL MICROSOFT NOW^</p^> 
echo ^<p^>937-754-7950^</p^> 
echo ^</font^> 
echo ^</body^>
echo.
...
echo ^<p^>DO NOT ATTEMPT TO RESTART OR SHUT DOWN YOUR COMPUTER^</p^> 
echo.
echo. 
echo ^</font^> 
echo ^</body^>
